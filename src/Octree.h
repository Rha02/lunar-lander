...
public:
	...
	vector<ofColor> colors = {
		ofColor::white, ofColor::red, ofColor::aquamarine,
		ofColor::purple, ofColor::green, ofColor::yellow,
		ofColor::lime, ofColor::violet, ofColor::orange,
		ofColor::pink
	};

	bool intersect(const Ray&, const TreeNode& node, int numLevels, int level, TreeNode& nodeRtn);
};